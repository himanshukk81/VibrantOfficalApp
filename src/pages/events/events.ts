...
export class EventsPage {
  eventList:any=[];
  reminderList:any=[];
  constructor(public budgetService:BudgetService, public events:Events,public reminderService:ReminderService,public eventService:EventService,public geolocation:Geolocation,public modalCtrl:ModalController,public service:SessionService,public navCtrl: NavController, public navParams: NavParams) {
   ...
   loadMap() {    
    ...
    this.map.one(GoogleMapsEvent.MAP_READY)
      .then(() => {
        ...
        this.addMarker(this.event,this.event.venueName,"blue")
